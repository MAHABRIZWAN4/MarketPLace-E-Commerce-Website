...
// // Configure the Sanity client with the new API token
...
//         _type: "reference",
//         _ref: item.id, // Ensure this references the correct product document ID
//       })),
//       total: total,
//       discount: discount,
...
//         },
//         body: JSON.stringify({ products: cartItems, orderData }), // Include orderData in the request body
//       });
...
//         handleCheckout(); // Call the handleCheckout function to initiate Stripe checkout
//       }
//     });
//   };
